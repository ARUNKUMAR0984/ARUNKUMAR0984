...
<details>
  <summary><b>🎮 2048 Game (Published on Play Store)</b></summary>
  <br>
  
  A clean and functional version of the popular 2048 game featuring:
  - 🎨 Dark & Light modes
  - 🔄 Undo and Restart functionality
  - 🎯 Game logic from scratch with Flutter
  - 💰 Ad integration: banner, interstitial & rewarded ads
  
  **Tech Stack**: Flutter, AdMob
  
  📱 View on Play Store
</details>

<details>
  <summary><b>📜 Daily Quotes App</b></summary>
  <br>
  
  A motivational quotes app designed to uplift users daily:
  - 📅 Quote of the day notifications
  - 🔖 Bookmark and share quotes
  - 🎨 Elegant UI with dark mode
  - 📈 Plans for quote categorization and user submissions
  
  **Tech Stack**: Flutter, Supabase, Notifications API
  
  📱 View on Play Store
</details>

<details>
  <summary><b>📱 Syllo - Student Productivity App</b></summary>
  <br>
  
  An all-in-one solution for student productivity:
  - 📝 Smart notes & tag-based categorization
  - ⏰ Pomodoro timer with task reminders
  - 📚 Cloud-based resource management
  - 🚫 App notification blocker for focus mode
  
  **Tech Stack**: Flutter, Supabase, Firebase Auth, Google Drive API
...
<details>
  <summary><b>💧 Real-Time Water Quality Monitoring System</b></summary>
  <br>
  
  An IoT + Mobile project for smart environmental monitoring:
  - 🌡️ Monitors pH, Turbidity, Temperature, and Humidity
  - 📟 Sensor integration with microcontroller & LCD
  - 📲 Live Flutter app visualization
  - 📊 Graphs using fl_charts
  
  **Tech Stack**: Arduino, Sensors, LCD, Flutter
</details>

<h2> 📊 Machine Learning & Analytics Projects</h2>

<details>
  <summary><b>📊 Mobile BI App with Visual Optimization</b></summary>
  <br>
  
  Final-year project focused on enhancing UX in mobile business intelligence:
  - 📈 Interactive charts using fl_charts
  - 🎯 Data-driven UX customization
  - 📊 Optimized layouts for analytics
  - 🗂️ Clean dashboard UI
  
  **Tech Stack**: Flutter, Dart, SQLite
  
  **Research**: "Optimizing Data Visualization Techniques for Enhanced UX in Mobile BI"
</details>

<details>
  <summary><b>🧠 ML-Powered Study Recommendation Engine (Idea Stage)</b></summary>
  <br>
  
  An upcoming AI model for Syllo that recommends:
  - 📚 Study content based on user behavior
  - 📅 Smart scheduling based on historical performance
  - 📈 Feedback-based ranking system
  
  **Tech Stack**: Flutter, Python (ML), Supabase, TensorFlow Lite (Planned)
</details>

<h2>🛠️ Learning & Development Projects</h2>

<details>
  <summary><b>🔗 Affiliate Marketing App (Idea Stage)</b></summary>
  <br>
  
  Helping students earn via curated affiliate marketing:
  - 🛒 Shortened product links
...
<details>
  ...
  App template to host and distribute public textbooks:
  - 🔍 Subject-wise filtering
  - 📁 Google Drive file export integration
  - 📱 Optimized for multiple state curriculums
  
  **Tech Stack**: Flutter, Google Drive API
  
  ⏱️ Built in under 4 days
</details>
